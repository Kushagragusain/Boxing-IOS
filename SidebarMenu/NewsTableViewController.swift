...
class NewsTableViewController: UITableViewController {
    ...
    @IBOutlet weak var imageChanging: UIImageView!
...
//            revealViewController().rearViewRevealWidth = 62
        ...
        imageChanging.animationImages = [
            UIImage(named: "watchkit-intro.jpg")!,
            UIImage(named: "webkit-featured.jpg")!,
            /*UIImage(named: "custom-segue-featured-1024.jpg")!*/]
        
        imageChanging.animationDuration = 10.0
        imageChanging.startAnimating()
    }
